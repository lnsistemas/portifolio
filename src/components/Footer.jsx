      ...
      <div className="container footer__inner">
        <div className="footer__brand">
          <div className="footer__logo">
            ...
            <span className="footer__logo-name">Nardiello</span>
          </div>
          <p className="footer__tagline">Tecnologia simples que funciona para você.</p>
        </div>
        ...
        <div className="footer__contact">
          ...
          <a href="mailto:lnsistemascontato@gmail.com" className="footer__contact-item">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              <rect x="2" y="4" width="20" height="16" rx="2"/>
              <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
            </svg>
            lnsistemascontato@gmail.com
          </a>
          <a href="https://instagram.com/sistemasln" target="_blank" rel="noopener noreferrer" className="footer__contact-item">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="footer__bottom">
        <div className="container">
          <p className="footer__copy">
            © {year} Leandro Nardiello. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
