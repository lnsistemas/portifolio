...
const highlights = [
  { label: 'Atendimento rápido', description: 'Resposta em até 24h para orçamentos e dúvidas.' },
  { label: 'Preço justo', description: 'Soluções acessíveis pensadas para autônomos e pequenos negócios.' },
  { label: 'Entrega prática', description: 'Projetos simples e funcionais, sem enrolação.' },
]
    ...
    <section id="about" className="section about">
      <div className="container about__inner">
        <div className="about__content">
          <p className="section-label">Quem sou eu</p>
